...
# This is copied directly from activerecord/test/cases/helper.rb
# The only difference is, we decide whether to load_schema or do
# a RESTORE based on an environment variable.
